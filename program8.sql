...
WHERE e.job <> 'CLERK'
ORDER BY e.sal DESC;
5. Employee name, job & manager name
Include employees without manager
...
FROM employee e
LEFT JOIN employee m ON e.mgr = m.empno;
Very common SELF JOIN question
